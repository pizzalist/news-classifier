<template>
  <div>
    ...
    <!-- 모달창 -->
    <div class="black-bg" v-if="오토뉴스선택설정창 == true">
      <!-- 밖에 어둡게 해주는 부분 -->
      <div class="white-bg">
        <div>
          <svg
        ...
        <div class="modalDiv">
          ...
          <div class="newsNum">
            <div class="news1">
              ...
              <span class="newsText">뉴스 개수</span>
            </div>
            <div class="news2">
          ...
          <div class="category">
            <div class="cate1">
              ...
              <span class="limitText"> 최대 1개이상 선택해주세요. </span>
            </div>
            <div class="cate2">
              <input
                type="checkbox"
          ...
          <div class="completeBtn">
            <div class="ButtonArea">
              <BlueButton ButtonText="완료" @click="submitSettings" />
            </div>
          </div>
        </div>
      </div>
